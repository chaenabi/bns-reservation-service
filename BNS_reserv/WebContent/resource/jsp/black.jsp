	...
	<div class="sidenav" id="sidenav">
		...
		<ul class="sidemenu">
			...
			<li class="d1"><a href="#" class="d1"><span>경국지색</span></a>
				<div class="inner">
					<div class="core">
						<strong class="datetime">10월 31일</strong>
						<strong class="datetime">수요일</strong>
						<ul class="list">
	...
	<div class="order" id="order">
		<div class="menu">
			<div class="menupan">
				...
				<p>천독룡</p>
				화염귀걸이<input type="checkbox" /> 번개귀걸이<input type="checkbox" /> 파천주<input
					type="checkbox"> 1번보패<input type="checkbox">
